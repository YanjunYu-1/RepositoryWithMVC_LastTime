...
namespace RepositoryWithMVC_LastTime.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(RepositoryWithMVC_LastTimeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Customer != null ? 
                          ...
                          Problem("Entity set 'RepositoryWithMVC_LastTimeContext.Customer'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RepositoryWithMVC_LastTimeContext.Customer'  is null.");
            }
            var customer = await _context.Customer.FindAsync(id);
            if (customer != null)
            {
